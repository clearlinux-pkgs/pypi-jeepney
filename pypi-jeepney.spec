...
Source0  : https://files.pythonhosted.org/packages/7b/6f/357efd7602486741aa73ffc0617fb310a29b588ed0fd69c2399acbb85b0c/jeepney-0.9.0.tar.gz
...
%prep
%setup -q -n jeepney-0.9.0
cd %{_builddir}/jeepney-0.9.0
pushd ..
cp -a jeepney-0.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740698995
